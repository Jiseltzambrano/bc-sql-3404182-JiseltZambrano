...
-- Requisitos cubiertos: 3 o más tablas, nombres en inglés, snake_case,
-- NOT NULL, DEFAULT, UNIQUE, CHECK, FK y CREATE TABLE IF NOT EXISTS.
...
-- Datos mínimos para probar el DDL
...
-- Verificación de tablas creadas en PostgreSQL.
SELECT
    table_name AS "Tabla creada"
FROM information_schema.tables
WHERE table_schema = 'tienda_muebles'
ORDER BY table_name;
